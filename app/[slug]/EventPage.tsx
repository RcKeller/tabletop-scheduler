...
export function EventPage({ event }: EventPageProps) {
  ...
  // Calculate week start from event dates
  ...
  useEffect(() => {
    ...
    loadHeatmapData();
  }, [event.slug, currentWeekStart, refreshKey]);
    ...
    <div className="flex min-h-screen flex-col">
        ...
        <div className="mx-auto max-w-7xl px-4 py-4">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="flex items-start gap-4">
              {/* Campaign/Game System Image */}
              {(event.campaignImageBase64 || event.gameSystem?.imageBase64) && (
                <img
                  src={event.campaignImageBase64 || event.gameSystem?.imageBase64 || ""}
                  alt=""
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-7xl px-4 py-6">
          ...
          <div className="mb-6">
            {isLoading ? (
              <div className="flex h-64 items-center justify-center rounded-lg border border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-900">
              ...
              <div className="flex h-64 items-center justify-center rounded-lg border border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-900">
                <div className="text-center">
                  ...
                  <p className="mt-1 text-sm text-zinc-400 dark:text-zinc-500">
                    {currentParticipant
                      ? "Add your availability below to get started"
                      : "Join the campaign and add your availability"}
                  </p>
                </div>
              </div>
            ) : (
      ...
      <footer className="border-t border-zinc-200 bg-white py-4 dark:border-zinc-800 dark:bg-zinc-900">
        <div className="mx-auto max-w-7xl px-4 text-center text-sm text-zinc-500 dark:text-zinc-400">
          ...
          <div>When2Play - Made for tabletop gamers</div>
        </div>
      </footer>
    </div>
  );
